        ...
        if (token) {
            try {
                const res = await axios.put(
                    `/api/private/settings/changepass/${id}`,
                    {
                        oldPass,
                        newPass,
                    },
    ...
    render() {
        ...
        return (
            <>
                ...
                <Dialog title={'Change password'} onClose={this.handleCloseLoginDialog} visible={visible}>
                                ...
                                <UIForm onSubmit={handleSubmit}>
                                    ...
                                    <div className={styles.row}>
                                        <Button
                                            type={'submit'}
                                            disabled={
                                                submitting || pristine || hasValidationErrors /*|| hasSubmitErrors*/
                                            }
                                        >
                                            Change
                                        </Button>
