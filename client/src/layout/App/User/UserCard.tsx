...
const UserCard: React.FC<IProps> = ({username, age, vk, instagram, telegram, imgUrl, date}) => (
    <Card>
        ...
        <Card.Content>
            ...
            <Card.Meta>{age ? <span>Age: {age}</span> : null}</Card.Meta>
            <Card.Description>
                {vk ? (
                    <p className={styles.addSN}>
                        <VKLogo className={styles.logo} /> {vk}
                    </p>
                ) : null}
                {instagram ? (
                    <p className={styles.addSN}>
                        <InstLogo className={styles.logo} /> {instagram}
                    </p>
                ) : null}
                {telegram ? (
                    <p className={styles.addSN}>
                        <TelegramLogo className={styles.logo} /> {telegram}
                    </p>
                ) : null}
            </Card.Description>
        </Card.Content>
